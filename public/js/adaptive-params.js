...
// same `schemas` object GET /api/image/catalog returns. Only three
// control types are ever rendered: <select>, <input type=range>, and a
// checkbox. There is no free-text number input anywhere in this renderer.
//
// Schema field shape:
//   {
